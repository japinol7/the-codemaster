...
NPCs should be able to kill a player's life when they cast combat spells on them.
"""
...
def test_pc_hit_with_fire_breath_spell_must_die(game):
    player = game.player
...
@game_test(levels=[3], timeout=3)
def test_pc_hit_with_neutrinos_bolt_must_die(game):
    player = game.player
    player.rect.x, player.rect.y = 260, 620
    player.health = 22
    player.lives = 1
...
@game_test(levels=[3], timeout=3)
def test_pc_hit_with_samutrinos_bolt_must_die(game):
    player = game.player
    player.rect.x, player.rect.y = 260, 620
    player.health = 22
    player.lives = 1
...
@game_test(levels=[3], timeout=3)
def test_pc_hit_with_mutentrinos_bolt_must_die(game):
    player = game.player
    player.rect.x, player.rect.y = 260, 620
    player.health = 22
    player.lives = 1
...
def test_pc_hit_with_vortex_doom_spell_must_die(game):
    player = game.player
    player.rect.x, player.rect.y = 260, 620
    player.health = 22
    player.lives = 1
...
@game_test(levels=[3], timeout=6)
def test_pc_hit_with_doom_bold_spell_must_die(game):
    player = game.player
    player.rect.x, player.rect.y = 260, 620
    player.health = 22
    player.lives = 1
...
@game_test(levels=[3], timeout=3)
def test_pc_hit_with_enough_drain_life_spells_must_die(game):
