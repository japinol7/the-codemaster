...
The player should be able to fetch items.
"""
...
def test_pc_fetches_three_batteries(game):
    player = game.player
...
def test_pc_fetches_two_apples(game):
    player = game.player
...
def test_pc_fetches_cartridge_with_bullets_t1(game):
    player = game.player
    player.rect.x, player.rect.y = 706, 640
...
@game_test(levels=[3], timeout=2)
def test_pc_fetches_cartridge_with_bullets_t2(game):
    player = game.player
    player.rect.x, player.rect.y = 706, 640
...
@game_test(levels=[4], timeout=2)
def test_pc_fetches_cartridge_with_bullets_t3(game):
    player = game.player
    player.rect.x, player.rect.y = 706, 640
...
@game_test(levels=[3], timeout=2)
def test_pc_fetches_cartridge_with_bullets_t4(game):
    player = game.player
    player.rect.x, player.rect.y = 706, 640
