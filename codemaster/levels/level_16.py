...
class Level16(Level):
    ...
    def _add_actors_hook(self):
        ...
        level_plats = [
            [6, 640, 380, platforms.PLAT_TYPE_01],
        ...
        # Add NPCs
        items_to_drop = [
            DropItem(PotionHealth, probability_to_drop=60, x_delta=16,
                     **{'random_min': 20, 'random_max': 20}),
            ]
        ...
        # Add doors
        self.doors.add([
            DoorLeftBlue(0, 550, self.game, level_dest=14, door_dest_pos=DOOR_DEST_NL),
