...
class Level15(Level):
    ...
    def __init__(self, id_, game):
        ...
        self.player_start_pos_right = 424, 408
    ...
    def _add_actors_hook(self):
        ...
        Grass.create_grass_sm(
            0, SCREEN_NEAR_EARTH , self.game, qty=5, qty_depth=4,
            actor_type=ActorType.PLAT_GRASS_M_SM)
        Grass.create_grass_sm(
            2700, SCREEN_NEAR_EARTH , self.game, qty=7, qty_depth=4,
            actor_type=ActorType.PLAT_GRASS_M_SM)
        ...
        # Add doors
        self.doors.add([
            DoorLeftYellow(0, 550, self.game, level_dest=13, door_dest_pos=DOOR_DEST_NL),
