...
class FireBreath(ActorMagic):
    """Represents a fire breath.
    ...
    def __init__(self, x, y, game, name=None, is_from_player_shot=None,
        ...
        self.file_name_key = 'im_fire_breath'
...
class FireBreathB(FireBreath):
    """Represents a fire breath, of type B."""
    actor_type = ActorType.FIRE_BREATH_B
    max_spells_on_target = 1
    power_min_to_use = {ActorType.FIRE_BREATH_B.name: 18,
                        }
    power_consumption = {ActorType.FIRE_BREATH_B.name: 14,
                         }
    ...
    def __init__(self, x, y, game, name=None, is_from_player_shot=None,
        ...
        self.type = ActorType.FIRE_BREATH_B
        self.stats = Stats()
        super().__init__(x, y, game, name=name,
        ...
        self.color_external = Color.YELLOW
        self.color_mode = pg.BLEND_RGB_ADD
        self.size_rand = 3, 8
        self.size_ext_multiplier = 1.8


class FireBreathA(FireBreath):
    """Represents a fire breath, of type A."""
    actor_type = ActorType.FIRE_BREATH_A
    max_spells_on_target = 1
    power_min_to_use = {ActorType.FIRE_BREATH_A.name: 20,
                        }
    power_consumption = {ActorType.FIRE_BREATH_A.name: 16,
                         }
    ...
    def __init__(self, x, y, game, name=None, is_from_player_shot=None,
        ...
        self.file_mid_prefix = '01'
        self.type = ActorType.FIRE_BREATH_A
        self.stats = Stats()
