...
class SamutrinosBolt(ActorMagic):
    """Represents a samurai neutrinos bolt.
    ...
    def __init__(self, x, y, game, name=None, is_from_player_shot=None,
        ...
        self.file_name_key = 'im_samutrinos_bolt'
...
class SamutrinosBoltB(SamutrinosBolt):
    """Represents a samurai neutrinos bolt, of type B."""
    actor_type = ActorType.SAMUTRINOS_BOLT_B
    max_spells_on_target = 1
    power_min_to_use = {ActorType.SAMUTRINOS_BOLT_B.name: 18,
                        }
    power_consumption = {ActorType.SAMUTRINOS_BOLT_B.name: 14,
                         }

    def __init__(self, x, y, game, name=None, is_from_player_shot=None,
                 owner=None, target=None,
                 change_x=7, change_y=5):
        self.file_mid_prefix = '01'
        self.type = ActorType.SAMUTRINOS_BOLT_B
        self.stats = Stats()
        super().__init__(x, y, game, name=name,
        ...
        self.color = 0, 20, 0
        self.color_external = 200, 10, 0
        self.color_mode = pg.BLEND_RGB_ADD
        self.size_rand = 3, 8
        self.size_ext_multiplier = 1.8


class SamutrinosBoltA(SamutrinosBolt):
    """Represents a samurai neutrinos bolt, of type A."""
    actor_type = ActorType.SAMUTRINOS_BOLT_A
    max_spells_on_target = 1
    power_min_to_use = {ActorType.SAMUTRINOS_BOLT_A.name: 20,
                        }
    power_consumption = {ActorType.SAMUTRINOS_BOLT_A.name: 16,
                         }

    def __init__(self, x, y, game, name=None, is_from_player_shot=None,
                 owner=None, target=None,
                 change_x=7.4, change_y=6.8):
        self.file_mid_prefix = '01'
        self.type = ActorType.SAMUTRINOS_BOLT_A
        self.stats = Stats()
